...
export class ItemService {
  constructor(
    ...
    @Inject('ITEM_CHAP_REPOSITORY') private itemChapRepository: typeof Item_chaps,
    @Inject('ITEM_CHAP_IMAGE_REPOSITORY') private itemChapImageRepository: typeof Item_chap_images,
   ) {}
